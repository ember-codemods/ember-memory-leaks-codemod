...
[![Build Status](https://travis-ci.org/ember-codemods/ember-memory-leaks-codemod.svg?branch=master)](https://travis-ci.org/ember-codemods/ember-memory-leaks-codemod) 
[![Coverage Status](https://coveralls.io/repos/github/ember-codemods/ember-memory-leaks-codemod/badge.svg?branch=master)](https://coveralls.io/github/ember-codemods/ember-memory-leaks-codemod?branch=master)
...
[![dependencies Status](https://david-dm.org/ember-codemods/ember-memory-leaks-codemod/status.svg)](https://david-dm.org/ember-codemods/ember-memory-leaks-codemod)
[![devDependencies Status](https://david-dm.org/ember-codemods/ember-memory-leaks-codemod/dev-status.svg)](https://david-dm.org/ember-codemods/ember-memory-leaks-codemod?type=dev)
